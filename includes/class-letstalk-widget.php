 ...
 */
class Letstalk_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Letstalk latest comments', 'letstalk' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display latest comments from topishare', 'letstalk' );
	...
	function widget( $args, $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/letstalk-display-widget.php' );
