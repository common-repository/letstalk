 ...
 */
function letstalk_get_max( $array ) {

	return Letstalk_Globals::get_max( $array );
 ...
 */
function letstalk_get_svg( $svg ) {

	return Letstalk_Globals::get_svg( $svg );
 ...
 */
function letstalk_get_template( $name ) {

	return Letstalk_Globals::get_template( $name );

}

class Letstalk_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'letstalk-template-paths', $locations );
